...
class Category extends Base_controller {
    ...
    function __construct()
    {
        ...
        parent::__construct();
        $this->load->library(config_item('app_path').'/'.'post_lib');
    ...
    public function save_post(){
        ...
        $stt=FALSE;
        $msg='';
        $param = $this->post_lib->validate_save($param);
        if($param){
        	$param = $this->post_lib->handle_save($param);
            $stt = $this->post_lib->save($param);
            if(!$stt){
                $msg = 'Error! Cannot save post.';
            }
        }
